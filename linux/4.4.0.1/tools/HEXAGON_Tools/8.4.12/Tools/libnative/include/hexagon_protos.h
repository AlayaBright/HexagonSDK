...
#ifndef __HEXAGON_PROTOS_HEADER_
#define __HEXAGON_PROTOS_HEADER_ 1
...
extern int Q6_OVF;
extern void libnative_use_hmx_v1();
extern void libnative_use_hmx_v2();
...
Word32 Q6_R_memub_M_circ(void** StartAddress, Word32 Mu, void* BaseAddress);
...
Word32 Q6_R_memuh_M_circ(void** StartAddress, Word32 Mu, void* BaseAddress);
...
void Q6_memw_IMR_circ(void** StartAddress, Word32 Is4_2, Word32 Mu, Word32 Rt, void* BaseAddress);
...
Word64 Q6_P_vdmpyw_PP(Word64 Rss, Word64 Rtt);
Word64 Q6_P_vdmpywacc_PP(Word64 Rxx, Word64 Rss, Word64 Rtt);
...
Float32 Q6_R_sfadd_RR(Float32 Rs, Float32 Rt);
Float32 Q6_R_sfsub_RR(Float32 Rs, Float32 Rt);
Float32 Q6_R_sfmpy_RR(Float32 Rs, Float32 Rt);
Float32 Q6_R_sfmpyacc_RR(Float32 Rx, Float32 Rs, Float32 Rt);
Float32 Q6_R_sfmpyacc_RRp_scale(Float32 Rx, Float32 Rs, Float32 Rt, Byte Pu);
Float32 Q6_R_sfmpynac_RR(Float32 Rx, Float32 Rs, Float32 Rt);
Float32 Q6_R_sfmpyacc_RR_lib(Float32 Rx, Float32 Rs, Float32 Rt);
Float32 Q6_R_sfmpynac_RR_lib(Float32 Rx, Float32 Rs, Float32 Rt);
Byte Q6_p_sfcmp_eq_RR(Float32 Rs, Float32 Rt);
Byte Q6_p_sfcmp_gt_RR(Float32 Rs, Float32 Rt);
Byte Q6_p_sfcmp_ge_RR(Float32 Rs, Float32 Rt);
Byte Q6_p_sfcmp_uo_RR(Float32 Rs, Float32 Rt);
Float32 Q6_R_sfmax_RR(Float32 Rs, Float32 Rt);
Float32 Q6_R_sfmin_RR(Float32 Rs, Float32 Rt);
Byte Q6_p_sfclass_RI(Float32 Rs, Word32 Iu5);
Float32 Q6_R_sfmake_I_pos(Word32 Iu10);
Float32 Q6_R_sfmake_I_neg(Word32 Iu10);
Float32 Q6_R_sffixupn_RR(Float32 Rs, Float32 Rt);
Float32 Q6_R_sffixupd_RR(Float32 Rs, Float32 Rt);
Float32 Q6_R_sffixupr_R(Float32 Rs);
Float64 Q6_P_dfadd_PP(Float64 Rss, Float64 Rtt);
Float64 Q6_P_dfsub_PP(Float64 Rss, Float64 Rtt);
Float64 Q6_P_dfmax_PP(Float64 Rss, Float64 Rtt);
Float64 Q6_P_dfmin_PP(Float64 Rss, Float64 Rtt);
Float64 Q6_P_dfmpyfix_PP(Float64 Rss, Float64 Rtt);
Float64 Q6_P_dfmpyll_PP(Float64 Rss, Float64 Rtt);
Float64 Q6_P_dfmpylhacc_PP(Float64 Rxx, Float64 Rss, Float64 Rtt);
Float64 Q6_P_dfmpyhhacc_PP(Float64 Rxx, Float64 Rss, Float64 Rtt);
Byte Q6_p_dfcmp_eq_PP(Float64 Rss, Float64 Rtt);
Byte Q6_p_dfcmp_gt_PP(Float64 Rss, Float64 Rtt);
Byte Q6_p_dfcmp_ge_PP(Float64 Rss, Float64 Rtt);
Byte Q6_p_dfcmp_uo_PP(Float64 Rss, Float64 Rtt);
Byte Q6_p_dfclass_PI(Float64 Rss, Word32 Iu5);
Float64 Q6_P_dfmake_I_pos(Word32 Iu10);
Float64 Q6_P_dfmake_I_neg(Word32 Iu10);
Float64 Q6_P_convert_sf2df_R(Float32 Rs);
Float32 Q6_R_convert_df2sf_P(Float64 Rss);
Float32 Q6_R_convert_uw2sf_R(Word32 Rs);
Float64 Q6_P_convert_uw2df_R(Word32 Rs);
Float32 Q6_R_convert_w2sf_R(Word32 Rs);
Float64 Q6_P_convert_w2df_R(Word32 Rs);
Float32 Q6_R_convert_ud2sf_P(Word64 Rss);
Float64 Q6_P_convert_ud2df_P(Word64 Rss);
Float32 Q6_R_convert_d2sf_P(Word64 Rss);
Float64 Q6_P_convert_d2df_P(Word64 Rss);
Word32 Q6_R_convert_sf2uw_R(Float32 Rs);
Word32 Q6_R_convert_sf2w_R(Float32 Rs);
Word64 Q6_P_convert_sf2ud_R(Float32 Rs);
Word64 Q6_P_convert_sf2d_R(Float32 Rs);
Word32 Q6_R_convert_df2uw_P(Float64 Rss);
Word32 Q6_R_convert_df2w_P(Float64 Rss);
Word64 Q6_P_convert_df2ud_P(Float64 Rss);
Word64 Q6_P_convert_df2d_P(Float64 Rss);
Word32 Q6_R_convert_sf2uw_R_chop(Float32 Rs);
Word32 Q6_R_convert_sf2w_R_chop(Float32 Rs);
Word64 Q6_P_convert_sf2ud_R_chop(Float32 Rs);
Word64 Q6_P_convert_sf2d_R_chop(Float32 Rs);
Word32 Q6_R_convert_df2uw_P_chop(Float64 Rss);
Word32 Q6_R_convert_df2w_P_chop(Float64 Rss);
Word64 Q6_P_convert_df2ud_P_chop(Float64 Rss);
Word64 Q6_P_convert_df2d_P_chop(Float64 Rss);
...
void Q6_dmstart_A(void* A);
void Q6_dmlink_AA(void* A, void* B);
Word32 Q6_R_dmpoll();
Word32 Q6_R_dmwait();
Word32 Q6_R_dmsyncht();
Word32 Q6_R_dmtlbsynch();
Word32 Q6_R_dmcfgrd_R(Word32 Rs);
void Q6_dmcfgwr_RR(Word32 Rs, Word32 Rt);
Word32 Q6_R_dmpause();
void Q6_dmresume_R(Word32 Rs);
...
#else /* __hexagon__ */
#error "You are using a compiler that generates Hexagon object code. This is the wrong version of hexagon_protos.h for the Hexagon compiler."
#endif /* __hexagon__ */

#endif /* __HEXAGON_PROTOS_HEADER_ */
