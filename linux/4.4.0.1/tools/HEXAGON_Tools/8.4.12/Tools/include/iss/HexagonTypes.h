...
typedef enum hexagon_cpu_t
{
    ...
    HEX_CPU_V67C_PINE = HEX_CPU_ID_V67C_PINE,
    ...
    HEX_CPU_V67V      = HEX_CPU_ID_V67V    ,
    HEX_CPU_V67V_128  = HEX_CPU_ID_V67V_128,
    HEX_CPU_V67V_1024 = HEX_CPU_ID_V67V_1024,
    HEX_CPU_V67V_2048 = HEX_CPU_ID_V67V_2048,
    HEX_CPU_V67V_3072 = HEX_CPU_ID_V67V_3072,
    ...
    HEX_CPU_V68N_1024 = HEX_CPU_ID_V68N_1024, // NSP, has both HVX & HMX
    HEX_CPU_V68Q_1024 = HEX_CPU_ID_V68Q_1024, // NSP, has both HVX & HMX
    HEX_CPU_V68NA     = HEX_CPU_ID_V68NA,
    HEX_CPU_V68NB     = HEX_CPU_ID_V68NB,
    HEX_CPU_V68NC     = HEX_CPU_ID_V68NC,
    HEX_CPU_V68       = HEX_CPU_ID_V68N_1024,
    HEX_CPU_V69C_MARVIN  = HEX_CPU_ID_V69C_MARVIN,
    HEX_CPU_V69H_MDM_SCA = HEX_CPU_ID_V69H_MDM_SCA,
    HEX_CPU_V69V_MDM_VEC = HEX_CPU_ID_V69V_MDM_VEC, // with Silver
    HEX_CPU_V69          = HEX_CPU_ID_V69H_MDM_SCA,
	HEX_CPU_FIRST_SUPPORTED = HEX_CPU_V62
} HEXAPI_Cpu;
...
typedef enum thread_register_t
{
    ...
    TH_REG_GPCYCLE1T = TH_REG_G12,
    TH_REG_GPCYCLE2T = TH_REG_G13,
    TH_REG_GPCYCLE3T = TH_REG_G14,
    TH_REG_GPCYCLE4T = TH_REG_G15,
    TH_REG_GPCYCLE5T = TH_REG_G16,
    TH_REG_GPCYCLE6T = TH_REG_G17,

    // arch_v69
    TH_REG_GCOMMIT7T = TH_REG_G10,
    TH_REG_GPCYCLE7T = TH_REG_G11,
    TH_REG_GCOMMIT8T = TH_REG_G18,
    TH_REG_GPCYCLE8T = TH_REG_G19,
