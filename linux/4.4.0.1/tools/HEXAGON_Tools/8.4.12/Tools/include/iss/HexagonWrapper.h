...
public:
        ...
        HEXAPI_Status  ConfigureGProf(const char *gprofFilePath = NULL, int fast=0);
        ...
        HEXAPI_Status  ConfigureExtraFlags(const char *extra_flags);
        ...
        // Simulator Control
        HEXAPI_Status       FastForward(int level);
        ...
        HEXAPI_Status  ValidateThreadNum(HEX_4u_t tnum);
        HEXAPI_Status  ValidateThreadNum(HEX_4u_t core_id, HEX_4u_t tnum);
        HEXAPI_Status  WriteThreadRegister(HEX_4u_t tnum, HEXAPI_TH_REG index, HEX_4u_t value);
        HEXAPI_Status  WriteThreadRegister(HEX_4u_t core_id, HEX_4u_t tnum, HEXAPI_TH_REG index, HEX_4u_t value);
        HEXAPI_Status  ReadThreadRegister(HEX_4u_t tnum, HEXAPI_TH_REG index, HEX_4u_t *value);
        HEXAPI_Status  ReadThreadRegister(HEX_4u_t core_id, HEX_4u_t tnum, HEXAPI_TH_REG index, HEX_4u_t *value);
        HEXAPI_Status  WriteGlobalRegister(HEXAPI_G_REG index, HEX_4u_t value);
        HEXAPI_Status  WriteGlobalRegister(HEX_4u_t core_id, HEXAPI_G_REG index, HEX_4u_t value);
        HEXAPI_Status  ReadGlobalRegister(HEXAPI_G_REG index, HEX_4u_t *value);
        HEXAPI_Status  ReadGlobalRegister(HEX_4u_t core_id, HEXAPI_G_REG index, HEX_4u_t *value);
        ...
        HEXAPI_Status  WriteSpecialRegister(HEX_4u_t tnum, HEXAPI_RegType regtype, HEX_4u_t index, HEX_8u_t value);
        HEXAPI_Status  ReadSpecialRegister(HEX_4u_t tnum, HEXAPI_RegType regtype, HEX_4u_t index, HEX_8u_t *value);
        ...
        HEXAPI_Status DumpPacketAnalysis(FILE *fp);
        ...
        // v68 HMX register
        HEXAPI_Status WriteHMXaccumulator(void *dsp, int arrayno, int spatial_idx, int channel_idx, HEX_4u_t word_idx, HEX_4u_t val);
        HEXAPI_Status ReadHMXaccumulator(void *dsp, int arrayno, int spatial_idx, int channel_idx, HEX_4u_t word_idx, HEX_4u_t *val);
        HEXAPI_Status EnableHMXinfo(int value);
};
