 ...
 */
 ...
 #elif defined(__hexagon__) || defined(__hexagonv__)	/* HEXAGON */
  #define _D0		3	/* 0: big endian, 3: little endian floating-point */
  #define _DLONG	0	/* 0: 64, 1: 80, 2: 128 long double bits */
  #define _LBIAS	0x3fe	/* 64 long double bits */
  #define _LOFF		4	/* 64 long double bits */
...
typedef unsigned int _Sizet;
 ...
 #if !defined(_HAS_C9X)
  #if defined(_C99) || (__STDC_VERSION__ >= 199901L) || (__cplusplus >= 201103L)
    #define _HAS_C9X	1
  #else
    #define _HAS_C9X	0
  #endif
...
#define _GLOBAL_LOCALE	1	/* 0 for per-thread locales, 1 for shared - Hexagon/QDSP6 */
...
#define _ATEXIT_T	void
 ...
 #if (_HAS_C9X) || (defined(__cplusplus))
  #define _HAS_INLINE 1
 #else
  #define _HAS_INLINE 0
 #endif

 #ifdef __GNUC_GNU_INLINE__
  #define _GNUC_EXTERN_INLINE extern
 #else
  #define _GNUC_EXTERN_INLINE
 #endif
