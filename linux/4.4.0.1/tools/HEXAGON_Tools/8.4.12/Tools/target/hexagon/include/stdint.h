...
/* C11 K3.4 Integer types.
For implemetations targeing machines with large address spaces
it is recommended that RSIZE_MAX be defined as the samller of the
size of largest object supported or (SIZE_MAX>>1) */
