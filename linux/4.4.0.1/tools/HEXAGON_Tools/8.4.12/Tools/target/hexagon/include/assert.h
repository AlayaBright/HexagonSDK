...
_C_LIB_DECL
_NO_RETURN(_Assert(const _Sysch_t *)) _NO_THROW;
_END_C_LIB_DECL
...
_C_LIB_DECL
_NO_RETURN(_Assert(const char *, const char *)) _NO_THROW;
_NO_RETURN(__assert(const char *, const char *, const char *, int)) _NO_THROW;
_END_C_LIB_DECL
 #endif /* _WIN32_WCE */
