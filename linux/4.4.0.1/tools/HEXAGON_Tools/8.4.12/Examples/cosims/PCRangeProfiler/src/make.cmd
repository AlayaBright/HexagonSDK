...
@set PATH_TEMP=%PATH%
call %COSIM_INIT%
%COSIM_CC% %COSIM_CFLAGS%  -c %TESTFILE_NAME%.c /Fo%CURRENT_DIR%\..\bin\%TESTFILE_NAME%.obj
%COSIM_CC% %CURRENT_DIR%\..\bin\%TESTFILE_NAME%.obj %COSIM_LINK% /out:%CURRENT_DIR%\..\bin\%TESTFILE_NAME%.dll
@set PATH=%PATH_TEMP%
