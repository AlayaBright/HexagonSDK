...
"-mcpu=hexagonv68" "-o" "/tmp/test-761baf.o" "/tmp/test-f11bc1.s"

// Linker:
"/prj/dsp/qdsp6/release/internal/branch-7.2/linux64/latest/Tools/bin/hexagon-link" "-march=hexagon" "-mcpu=hexagonv68" "-o" "a.out"
.....
