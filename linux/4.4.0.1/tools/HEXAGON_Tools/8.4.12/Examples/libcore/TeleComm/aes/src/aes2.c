...
/*****************************************************/
void aes_encrypt2(AES_CTX *ctx, UWord32 *EncryptTAB, uword8_4B_align *in, uword8_4B_align *out)
{
    UWord32 b0[4], b1[4];
    UWord32 *Si, *So, *temp;
...
/*****************************************************/
void aes_decrypt2(AES_CTX *ctx, UWord32 *DecryptTAB, uword8_4B_align *in, uword8_4B_align *out)
{
    UWord32 b0[4], b1[4];
    UWord32 *Si, *So, *temp;
