...
*******************************************************************************
This example demonstrates how to use the Vector Tightly Coupled Memory (VTCM)
with the scatter/gather features of the HVX coprocessor.  Please note that this
example only works with Hexagon Tools Versions 8.4.x and higher.  Also, the
architecture must be v65 or higher. Note that this example only uses 128B
vector length.
