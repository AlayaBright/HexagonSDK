...
unsigned int VTCM_BASE_ADDRESS			= 0;
unsigned int VTCM_SCATTER16_ADDRESS		= 0;
unsigned int VTCM_GATHER16_ADDRESS		= 0;
unsigned int VTCM_SCATTER32_ADDRESS		= 0;
unsigned int VTCM_GATHER32_ADDRESS		= 0;
unsigned int VTCM_SCATTER16_32_ADDRESS	= 0;
unsigned int VTCM_GATHER16_32_ADDRESS   = 0;
...
static uint32_t get_vtcm_base(void) 
{
	int vtcm_offset=0x038;

#if __HEXAGON_ARCH__ == 65
	return 0xD8200000L;
#elif __HEXAGON_ARCH__ == 67	
