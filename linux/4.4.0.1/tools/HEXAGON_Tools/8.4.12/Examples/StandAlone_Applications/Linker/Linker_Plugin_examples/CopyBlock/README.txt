...
shown below.
 (your file path will be different)
	...
	hexagon-clang -mv68 -G0 target/functions.o target/main.o -o target/main.elf -Wl,-T,target/linker.script,--trace=plugin,-Map,target/CopyBlock.map
...
[After the Hexagon linker is done, the makefile runs hexagon-llvm-readelf to show
the relative sizes of the .uncompress and .compress sections.]

	hexagon-llvm-readelf -S target/main.elf | grep -E "Address|compress"
...
the relative sizes of the .uncompress and .compress sections.]
	...
	hexagon-llvm-readelf -S .\target\main.elf | findstr "compress"
