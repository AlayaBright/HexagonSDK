...
@set PLUGIN_NAME=IslandSections
...
@set OBJS=(data_island,rodata_island,text_sw,text_island,vars,main)
...
@echo %CC% %CFLAGS% %TARGET_DIR%\*.o -o %TARGET_DIR%\main.elf -Wl,-T,%TARGET_DIR%\linker.script,--trace=plugin
