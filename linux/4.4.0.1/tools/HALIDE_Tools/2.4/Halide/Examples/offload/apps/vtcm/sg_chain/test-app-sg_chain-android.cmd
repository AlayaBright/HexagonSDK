...
bin\pipeline_generator.exe -g sg_chain -f pipeline -o ./bin/arm-64-android target=arm-64-android-hvx_128

call %ANDROID_ARM64_TOOLCHAIN%\bin\aarch64-linux-android21-clang++ -std=c++11 %INCLUDES% -I ./bin/arm-64-android -Wall -O3 process.cpp bin/arm-64-android/pipeline.a -o bin/arm-64-android/sg_chain-hvx128 -llog -fPIE -pie
...
%NORUN%  adb shell rm -f /data/sg_chain-hvx128
%NORUN%  adb push bin/arm-64-android/sg_chain-hvx128 /data/
%NORUN%  adb shell chmod +x /data/sg_chain-hvx128
%NORUN%  adb shell "/data/sg_chain-hvx128 10; echo status=$?" 2>&1 | tee adb.out
