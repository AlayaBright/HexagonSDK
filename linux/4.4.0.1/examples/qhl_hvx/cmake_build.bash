...
# Test on the Device
    ...
    adb push ${HEXAGON_BUILD}/ship/libqhl_hvx_example.so //vendor/lib/rfsa/dsp/sdk
    adb push ${HEXAGON_BUILD}/fft2D_float_real_test_data_HVX_in128x128.dat //vendor/lib/rfsa/dsp/sdk/
    adb shell "echo 0x1f > //vendor/lib/rfsa/dsp/sdk/run_main_on_hexagon.farf"
    adb shell "export LD_LIBRARY_PATH=//vendor/lib64/:$LD_LIBRARY_PATH ADSP_LIBRARY_PATH=\"//vendor/lib/rfsa/dsp/sdk;\" ; //vendor/bin/run_main_on_hexagon 3 //vendor/lib/rfsa/dsp/sdk/libqhl_hvx_example.so 128 //vendor/lib/rfsa/dsp/sdk/fft2D_float_real_test_data_HVX_in128x128.dat //vendor/lib/rfsa/dsp/sdk/fft2D_float_real_test_data_HVX_in128x128.out "
}
if [ "to$1" = "totest" ];
then
    ...
    doBuild "$@" TEST_NAME=qhl_hvx_example
    if [ "$?" -ne 0 ]
    then
        exit 1
