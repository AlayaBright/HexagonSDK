...
example_name = "queuetest"
unsupported_target_info = ["mannar","kamorta","sm6125","qcs403","qcs405","agatti","strait","monaco","divar"]

#******************************************************************************
# Parser for cmd line options
#******************************************************************************
parser = argparse.ArgumentParser(prog='asyncdspq_queuetest_walkthrough.py', description=__doc__, formatter_class=argparse.RawTextHelpFormatter)
...
def run_example():
	...
	print("---- Run asyncdspq_queuetest Example ----")
