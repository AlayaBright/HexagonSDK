...
/**@ingroup func_qurt_get_hthread_pcycles
  ...
  @note1hang Returns 0 when architecture is earlier than v67.
  
  @param[in] n Threads in run mode. Valid values are 1 through 6.
...
/**@ingroup func_qurt_get_hthread_commits
  ...
  @param[in] n Threads in run mode. Valid values: 1 through 6.
