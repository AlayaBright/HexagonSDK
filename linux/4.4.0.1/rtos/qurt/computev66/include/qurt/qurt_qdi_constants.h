...
#define QDI_ISLAND_ADD_VIRTADDR          32  // Method to add virtual address range to island spec dynamically
...
#define QDI_OS_DEBUG_MONITOR_PID_ADD              111
#define QDI_OS_DEBUG_MONITOR_PID_REMOVE           112
/* Letting the ASID definitions remain for backward compatibility */
#define QDI_OS_DEBUG_MONITOR_ASID_ADD             QDI_OS_DEBUG_MONITOR_PID_ADD
#define QDI_OS_DEBUG_MONITOR_ASID_REMOVE          QDI_OS_DEBUG_MONITOR_PID_REMOVE
...
#define QDI_OS_MEM_POOL_SIZE_CHK               141


#define QDI_CLIENT_HANDLE_BUFFER_LOCK2   142

#define QDI_OS_THREAD_GET_THREAD_ID            143

#define QDI_OS_INTERRUPT_CONFIG_REGISTER       144
#define QDI_OS_INTERRUPT_ENABLE_REGISTER       145
#define QDI_OS_INTERRUPT_DISABLE_REGISTER      146
#define QDI_OS_INTERRUPT_CONFIG_NOTIFY         147
#define QDI_OS_INTERRUPT_ENABLE_NOTIFY         148
#define QDI_OS_INTERRUPT_DISABLE_NOTIFY        149

#define QDI_OS_INTERRUPT_CONFIG_GET            156
#define QDI_OS_INTERRUPT_CONFIG_SET            157
...
#define QDI_PERM_W              2
#define QDI_PERM_R              1
#define QDI_PERM_RW             (QDI_PERM_R | QDI_PERM_W)
