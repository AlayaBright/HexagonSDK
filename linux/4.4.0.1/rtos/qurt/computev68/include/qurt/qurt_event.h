...
/**@ingroup func_qurt_sysenv_get_process_name2
  Gets information on the system environment process names based on client_handle.
...
/**@ingroup func_qurt_exception_wait3
  ...
  @datatypes
  @param[in] pointer to qurt_sysevent_error_1_t type structure
  @param[in] sizeof qurt_sysevent_error_1_t type structure

  @param[out] sys_err  Pointer to the error event record.
  @param[out] fkey  Returns FKEY of error thread.
