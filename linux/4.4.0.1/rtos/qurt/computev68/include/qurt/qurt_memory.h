...
extern qurt_mem_pool_t qurt_mem_default_pool __attribute__((section(".bss"))); /**< Memory pool object.*/
...
/**@ingroup func_qurt_mem_cache_clean2
  ...
  - #QURT_MEM_CACHE_INVALIDATE\n  
  - #QURT_MEM_CACHE_FLUSH_INVALIDATE\n 
  This operation flushes/invalidates the contents of all cache lines from start address
  to end address (start address + size). The contents of the adjoining buffer can be 
...
/**@ingroup func_qurt_mem_pool_create
  ...
  @cond rest_dist For more information on the system configuration file, refer to @xhyperref{80VB41979,80-VB419-79}. @endcond
...
/**@ingroup func_qurt_mem_region_attr_set_type
  ...
  applications. 
  @cond rest_dist For more information, refer to @xhyperref{80VB41992,80-VB419-92}. @endcond
...
/**@ingroup func_qurt_mem_region_attr_set_cache_mode
  ...
  @cond rest_dist For more information on the cache, refer to @xhyperref{80VB41992,80-VB419-92}.@endcond
...
/**@ingroup func_qurt_mem_region_attr_set_bus_attr
  ...
  @cond rest_dist For more information on the bus attribute bits, refer to the @xhyperref{80VB41992,80-VB419-92}. @endcond
...
/**@ingroup func_qurt_mem_region_query
  ...
  Once a memory region has been determined to exist, its attributes are
...
/**@ingroup func_qurt_lookup_physaddr
  ...
  The lookup happens in the process of the caller. Use qurt_lookup_physaddr2() to lookup the
...
/**@ingroup func_qurt_mem_region_query_64
  ...
  specified virtual or physical address. Once a memory region has been determined to exist, its attributes are
  accessible (Section @xref{sec:mem_region_attr_get}).
...
/**@ingroup func_qurt_lookup_physaddr_64
  ...
  The lookup happens in the process of the caller. Use qurt_lookup_physaddr2() to lookup the physical
...
/**@ingroup func_qurt_mem_syncht
  ...
  mem_locked, and so on) that originated from the current thread are completed and globally observable.
...
/**@ingroup func_qurt_lookup_physaddr2
  ...
  physical memory address it is mapped to.
