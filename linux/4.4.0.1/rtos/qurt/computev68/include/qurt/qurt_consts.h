...
GENERAL DESCRIPTION
  QuRT constants and definitions 
...
#define QURT_TCM_SET_TCM_DUMP_LOC           8

/** @addtogroup thread_macros
@{ */
#define QURT_MAX_HTHREAD_LIMIT    8 /**< The limit on the maximum number of hardware threads supported by QuRT for any
...
#define QURT_DUMP_DCTAGS   4  /* For testing purpose. */
...
#define QURT_CLEAN_INVALIDATE_L2  12  /* Flush and invalidate entire L2 cache. */
