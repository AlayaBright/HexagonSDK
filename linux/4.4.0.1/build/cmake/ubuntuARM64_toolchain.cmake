...
# Set the compilers
if(OPENWRT)
    set(UBUNTUARM_PREFIX ${UBUNTUARM_TOOLS_DIR}/bin/aarch64-openwrt-linux-musl-)
    set(UBUNTUARM_LIB_DIR ${UBUNTUARM_TOOLS_DIR}/libexec/gcc/aarch64-openwrt-linux-musl/5.2.0)
else()
    set(UBUNTUARM_PREFIX ${UBUNTUARM_TOOLS_DIR}/bin/aarch64-linux-gnu-)
    set(UBUNTUARM_LIB_DIR ${UBUNTUARM_TOOLS_DIR}/lib/gcc/aarch64-linux-gnu/4.9.3)
endif()
...
include_directories(SYSTEM ${UBUNTUARM_TOOLS_DIR}/libc/usr/include)
...
set(COMMON_FLAGS "-fpic -c -fPIC -Wall -Wno-missing-braces -DARM_ARCH_7A -DUSE_SYSLOG")
