/**=============================================================================
@file
    test_hf_vector_self_min_ahf.c

@brief
    Accuracy test for qhblas_hvx_hf_vector_self_min_ahf function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_hvx_hf_vector_self_min_ahf)

    TEST_INPUT_SCALAR_QFLOAT16(qhblas_hvx_hf_vector_self_min_ahf, ARR_LEN, output,
                               0.0f, input_arr)
