/**=============================================================================
@file
    bench_vector_self_min_ab.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_b_vector_self_min_ab function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_b_vector_self_min_ab function certain number of times
...
BENCH_TFUN(qhblas_hvx_b_vector_self_min_ab, input_arr, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_b_vector_self_min_ab, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
