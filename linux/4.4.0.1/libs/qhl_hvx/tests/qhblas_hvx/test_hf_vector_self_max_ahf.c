/**=============================================================================
@file
    test_hf_vector_self_max_ahf.c

@brief
    Accuracy test for qhblas_hvx_hf_vector_self_max_ahf function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_hvx_hf_vector_self_max_ahf)

    TEST_INPUT_SCALAR_QFLOAT16(qhblas_hvx_hf_vector_self_max_ahf, ARR_LEN, output,
                               0.0f, input_arr)
