/**=============================================================================
@file
    bench_vector_min_aw.c

@brief
    Benchmark for measuring performance of qhblas_hvx_vector_min_aw function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_vector_min_aw function certain number of times
...
BENCH_TFUN(qhblas_hvx_vector_min_aw, input_arr1, input_arr2, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_vector_min_aw, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
