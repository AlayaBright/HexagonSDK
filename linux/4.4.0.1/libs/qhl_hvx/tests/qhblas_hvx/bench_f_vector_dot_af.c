/**=============================================================================
@file
    bench_f_vector_dot_af.c

@brief
    Benchmark for measuring performance of qhblas_hvx_f_vector_dot_af function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_f_vector_dot_af function certain number of times
...
static float input_arr1[VEC_MAX_ARR_LEN];
static float input_arr2[VEC_MAX_ARR_LEN];
static float output;
...
BENCH_TFUN(qhblas_hvx_f_vector_dot_af, input_arr1, input_arr2, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_f_vector_dot_af, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
