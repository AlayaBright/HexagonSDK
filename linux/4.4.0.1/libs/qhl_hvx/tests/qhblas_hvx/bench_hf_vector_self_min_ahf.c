/**=============================================================================
@file
    bench_vector_self_min_ahf.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_hf_vector_self_min_ahf function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_hf_vector_self_min_ahf function certain number of times
...
BENCH_TFUN(qhblas_hvx_hf_vector_self_min_ahf, input_arr, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_hf_vector_self_min_ahf, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
