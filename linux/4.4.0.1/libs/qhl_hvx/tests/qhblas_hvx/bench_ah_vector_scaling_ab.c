/**=============================================================================
@file
    bench_ah_vector_scaling_ab.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_ah_vector_scaling_ab function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_ah_vector_scaling_ab function certain number of times
...
BENCH_TFUN(qhblas_hvx_ah_vector_scaling_ab, input_arr, scale_factor, output);
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_ah_vector_scaling_ab, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
