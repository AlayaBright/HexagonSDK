/**=============================================================================
@file
    bench_matrix_vector_mpy_ab.c

@brief
    Benchmark for measuring performance of qhblas_hvx_matrix_vector_mpy_ab function.

    Benchmark measures number of cycles needed for executing qhblas_hvx_matrix_vector_mpy_ab function
...
BENCH_TFUN(qhblas_hvx_matrix_vector_mpy_ab, input_arr1, input_arr2, output, M)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_matrix_vector_mpy_ab, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
