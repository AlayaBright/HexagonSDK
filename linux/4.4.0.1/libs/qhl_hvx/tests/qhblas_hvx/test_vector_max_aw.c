/**=============================================================================
@file
    test_vector_max_aw.c

@brief
    Accuracy test for qhblas_hvx_vector_max_aw function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A2(qhblas_hvx_vector_max_aw)

    TEST_INPUT_AH2(qhblas_hvx_vector_max_aw)
