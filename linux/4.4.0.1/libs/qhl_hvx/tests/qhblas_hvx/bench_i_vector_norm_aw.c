/**=============================================================================
@file
    bench_i_vector_norm_aw.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_i_vector_norm_aw function.
...
BENCH_TFUN(qhblas_hvx_i_vector_norm_aw, input_arr, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_i_vector_norm_aw, NR_OF_ITERATIONS, lengths_of_array, VEC_LEN)
