/**=============================================================================
@file
    bench_aw_vector_scaling_ah.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_aw_vector_scaling_ah function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_aw_vector_scaling_ah function certain number of times
...
BENCH_TFUN(qhblas_hvx_aw_vector_scaling_ah, input_arr, scale_factor, output);
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_aw_vector_scaling_ah, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
