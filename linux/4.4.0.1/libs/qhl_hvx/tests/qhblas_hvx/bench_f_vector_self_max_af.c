/**=============================================================================
@file
    bench_vector_self_max_af.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_f_vector_self_max_af function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_f_vector_self_max_af function certain number of times
...
BENCH_TFUN(qhblas_hvx_f_vector_self_max_af, input_arr, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_f_vector_self_max_af, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
