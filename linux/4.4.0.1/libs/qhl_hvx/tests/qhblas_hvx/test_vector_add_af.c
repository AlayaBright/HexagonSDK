...
@brief
    Accuracy test for qhblas_hvx_vector_add_af function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A2(qhblas_hvx_vector_add_af)

    TEST_INPUT_QFLOAT32_A2_T(qhblas_hvx_vector_add_af, 0.1f)
