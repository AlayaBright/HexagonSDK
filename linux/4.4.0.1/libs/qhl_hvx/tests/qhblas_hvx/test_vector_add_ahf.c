/**=============================================================================
@file
    test_vector_add_ahf.c

@brief
    Accuracy test for qhblas_hvx_vector_add_ahf function
...
inline static void generate_ref_output(uint32_t size)
{
    ...
    {
        ref_output[i] = (float)input_arr1[i] + (float)input_arr2[i];
    }
}
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A2(qhblas_hvx_vector_add_ahf)

    TEST_INPUT_QFLOAT16_A2_T(qhblas_hvx_vector_add_ahf, 1.0f)
