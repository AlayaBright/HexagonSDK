/**=============================================================================
@file
    bench_vector_self_max_ah.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_h_vector_self_max_ah function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_h_vector_self_max_ah function certain number of times
...
BENCH_TFUN(qhblas_hvx_h_vector_self_max_ah, input_arr, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_h_vector_self_max_ah, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
