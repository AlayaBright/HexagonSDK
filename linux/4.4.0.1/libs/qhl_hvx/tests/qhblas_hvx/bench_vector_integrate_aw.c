/**=============================================================================
@file
    bench_vector_integrate_aw.c

@brief
    Benchmark for measuring performance of qhblas_hvx_vector_integrate_aw function.

    Benchmark measures number of cycles needed for executing qhblas_hvx_vector_integrate_aw function
...
BENCH_TFUN(qhblas_hvx_vector_integrate_aw, input_arr, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_vector_integrate_aw, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
