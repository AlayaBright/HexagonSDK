/**=============================================================================
@file
    bench_matrix_vector_mpy_ah.c

@brief
    Benchmark for measuring performance of qhblas_hvx_matrix_vector_mpy_ah function.

    Benchmark measures number of cycles needed for executing qhblas_hvx_matrix_vector_mpy_ah function
...
BENCH_TFUN(qhblas_hvx_matrix_vector_mpy_ah, input_arr1, input_arr2, output, M)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_matrix_vector_mpy_ah, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
