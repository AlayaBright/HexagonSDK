/**=============================================================================
@file
    test_f_vector_self_min_af.c

@brief
    Accuracy test for qhblas_hvx_f_vector_self_min_af function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_hvx_f_vector_self_min_af)

    TEST_INPUT_SCALAR_QFLOAT32(qhblas_hvx_f_vector_self_min_af, ARR_LEN, output,
                               0.0f, input_arr)
