...
@brief
    Accuracy test for qhblas_hvx_vector_max_af function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A2(qhblas_hvx_vector_max_af)

    TEST_INPUT_QFLOAT32_A2_T(qhblas_hvx_vector_max_af, 0.0f)
