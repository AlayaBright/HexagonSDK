/**=============================================================================
@file
    bench_vector_integrate_af16.c

@brief
    Benchmark for measuring performance of qhblas_hvx_vector_integrate_ahf function.

    Benchmark measures number of cycles needed for executing qhblas_hvx_vector_integrate_ahf function
...
BENCH_TFUN(qhblas_hvx_vector_integrate_ahf, input_arr, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_vector_integrate_ahf, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
