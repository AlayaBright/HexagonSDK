/**=============================================================================
@file
    bench_vector_norm_ahf.c

@brief
    Benchmark for measuring performance of qhblas_hvx_hf_vector_norm_ahf function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_hf_vector_norm_ahf function certain number of times
...
BENCH_TFUN(qhblas_hvx_hf_vector_norm_ahf, input_arr, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_hf_vector_norm_ahf, NR_OF_ITERATIONS, lengths_of_array, VEC_LEN)
