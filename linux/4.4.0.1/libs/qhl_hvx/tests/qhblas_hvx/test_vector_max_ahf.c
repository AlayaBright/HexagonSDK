/**=============================================================================
@file
    test_vector_max_ahf.c

@brief
    Accuracy test for qhblas_hvx_vector_max_ahf function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A2(qhblas_hvx_vector_max_ahf)

    TEST_INPUT_QFLOAT16_A2_T(qhblas_hvx_vector_max_ahf, 0.0f)
