/**=============================================================================
@file
    bench_ah_vector_add_ab.c

@brief
    Benchmark for measuring performance of qhblas_hvx_ah_vector_add_ab function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_ah_vector_add_ab function certain number of times
...
BENCH_TFUN(qhblas_hvx_ah_vector_add_ab, input_arr1, input_arr2, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_ah_vector_add_ab, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
