/**=============================================================================
@file
    test_i_vector_norm_aw.c

@brief
    Accuracy test for qhblas_hvx_i_vector_norm_aw function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_hvx_i_vector_norm_aw)

    TEST_INPUT_SCALAR_INT16(qhblas_hvx_i_vector_norm_aw, ARR_LEN, output, input_arr)
