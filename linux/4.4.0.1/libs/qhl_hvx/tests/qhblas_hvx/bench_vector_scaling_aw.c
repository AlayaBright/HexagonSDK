/**=============================================================================
@file
    bench_vector_scaling_aw.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_vector_scaling_aw function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_vector_scaling_aw function certain number of times
...
static const int32_t scale_factor = (int32_t)(0.3*32768);
...
BENCH_TFUN(qhblas_hvx_vector_scaling_aw, input_arr, scale_factor, output);
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_vector_scaling_aw, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
