/**=============================================================================
@file
    test_w_vector_self_max_aw.c

@brief
    Accuracy test for qhblas_hvx_w_vector_self_max_aw function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_hvx_w_vector_self_max_aw)

    TEST_INPUT_SCALAR_INT16(qhblas_hvx_w_vector_self_max_aw, ARR_LEN, output, input_arr)
