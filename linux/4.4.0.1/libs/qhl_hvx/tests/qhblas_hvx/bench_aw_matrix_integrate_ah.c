/**=============================================================================
@file
    bench_aw_matrix_integrate_ah.c

@brief
    Benchmark for measuring performance of qhblas_hvx_aw_matrix_integrate_ah function.

    Benchmark measures number of cycles needed for executing qhblas_hvx_aw_matrix_integrate_ah function
...
BENCH_TFUN_HVX_MATRIX(qhblas_hvx_aw_matrix_integrate_ah, input_arr, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_aw_matrix_integrate_ah, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
