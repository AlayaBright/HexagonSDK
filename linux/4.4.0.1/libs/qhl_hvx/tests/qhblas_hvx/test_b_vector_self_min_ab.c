/**=============================================================================
@file
    test_b_vector_self_min_ab.c

@brief
    Accuracy test for qhblas_hvx_b_vector_self_min_ab function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_hvx_b_vector_self_min_ab)

    TEST_INPUT_SCALAR_INT16(qhblas_hvx_b_vector_self_min_ab, ARR_LEN, output, input_arr)
