...
@brief
    ...
    qhblas_hvx_vector_scaling_af function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_vector_scaling_af function certain number of times
...
BENCH_TFUN(qhblas_hvx_vector_scaling_af, input_arr, scale_factor, output);
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_vector_scaling_af, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
