/**=============================================================================
@file
    bench_matrix_integrate_af.c

@brief
    Benchmark for measuring performance of qhblas_hvx_matrix_integrate_af function.

    Benchmark measures number of cycles needed for executing qhblas_hvx_matrix_integrate_af function
...
BENCH_TFUN_HVX_MATRIX(qhblas_hvx_matrix_integrate_af, input_arr, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_matrix_integrate_af, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
