/**=============================================================================
@file
    bench_vector_scaling_ahf.c

@brief
    Benchmark for measuring performance of
    qhblas_hvx_vector_scaling_ahf function.

    Benchmark measures number of cycles needed for executing
    qhblas_hvx_vector_scaling_ahf function certain number of times
...
BENCH_TFUN(qhblas_hvx_vector_scaling_ahf, input_arr, &scale_factor, output);
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_hvx_vector_scaling_ahf, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
