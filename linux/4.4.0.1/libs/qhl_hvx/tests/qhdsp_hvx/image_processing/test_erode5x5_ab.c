...
@brief
    Accuracy test for qhdsp_hvx_erode5x5_ab function.
...
static void qhdsp_hvx_erode5x5_ab_ref(
    uint8_t *input,
    int32_t stride_i,
    uint32_t width,
    uint32_t height,
...
int main(int argc, char* argv[])
{
    ...
    printf("Test for qhdsp_hvx_erode5x5_ab function:\n");
    ...
    qhdsp_hvx_erode5x5_ab_ref(input, stride, width, height, output_ref, stride);
