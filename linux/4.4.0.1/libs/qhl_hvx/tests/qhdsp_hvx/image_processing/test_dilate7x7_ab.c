...
@brief
    Accuracy test for qhdsp_hvx_dilate7x7_ab function.
...
static void qhdsp_hvx_dilate7x7_ab_ref(
    uint8_t *input,
    int32_t stride_i,
    uint32_t width,
    uint32_t height,
...
int main(int argc, char* argv[])
{
    ...
    printf("Test for qhdsp_hvx_dilate7x7_ab function:\n");
    ...
    /*  Call test fuctions                                  */
    /* -----------------------------------------------------*/
    qhdsp_hvx_dilate7x7_ab(input, stride, width, height, output, stride);
    qhdsp_hvx_dilate7x7_ab_ref(input, stride, width, height, output_ref, stride);
