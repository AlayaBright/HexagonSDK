...
LIBS="qhmath_hvx qhblas_hvx qhdsp_hvx/fft qhdsp_hvx/lms"
...
REPORT_NAME=report-accuracy_tests-simulator
...
echo ---------------------------------------------------
echo Execute test_bkfir_ah_qhl
$HEXAGON_SIM $HEX_SIM_ARG output/sim/qhdsp_hvx/filters/test_bkfir_ah_qhl 2>&1 | grep -v "hexagon-sim" | tee -a $REPORT

echo ---------------------------------------------------
echo Execute test_bkfir_aw_qhl
$HEXAGON_SIM $HEX_SIM_ARG output/sim/qhdsp_hvx/filters/test_bkfir_aw_qhl 2>&1 | grep -v "hexagon-sim" | tee -a $REPORT
