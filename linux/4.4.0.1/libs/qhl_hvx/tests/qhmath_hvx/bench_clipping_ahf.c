/**=============================================================================
@file
    bench_clipping_ahf.c

@brief
    Benchmark for measuring performance of qhmath_hvx_clipping_ahf function.

    Benchmark measures number of cycles needed for executing
    qhmath_hvx_clipping_ahf function certain number of times
...
static __fp16 low_level = -110.0f;
static __fp16 high_level = 110.0f;
...
BENCH_TFUN_CLIPPING(qhmath_hvx_clipping_ahf, input_arr, output, &low_level, &high_level)
...
int main(void)
{
    ...
    BENCH_TCALL(qhmath_hvx_clipping_ahf, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
