...
@brief
    Accuracy test for qhmath_hvx_cosh_af function
...
int main(void)
{
    ...
    printf("Test for qhmath_hvx_cosh_af function:\n");
    ...
    for (uint32_t i = ARR_LEN; i <= ARR_LEN; ++i)
    {
        ...
        qhmath_hvx_cosh_af(input, output, i);
