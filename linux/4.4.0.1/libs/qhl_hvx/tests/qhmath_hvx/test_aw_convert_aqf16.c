/**=============================================================================
@file
   test_aw_convert_aqf16.c

@brief
    Accuracy test for qhmath_hvx_aw_convert_aqf16 function
...
int main() {
    ...
    qhmath_hvx_aw_convert_aqf16_ref (qf_ref, int_ref, SIZE);
    qhmath_hvx_aw_convert_aqf16 (qf_ref, int_test, SIZE);

    //compare bit accuracy  of qfloat conversion to int32

    if(qhmath_hvx_cmp_w(int_ref, int_test, SIZE, 1)) {
       printf("Conversion: qf16 -> int32 mismatches with reference implementation, FAIL!\n");
    } else {
       printf("Conversion: qf16 -> int32  matches with reference implementation, PASS! \n");
    }
/*======================================================================*/
    free(arg);
    free(int_test);
