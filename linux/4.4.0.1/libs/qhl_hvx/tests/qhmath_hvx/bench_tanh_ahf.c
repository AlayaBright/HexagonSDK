...
@brief
    Benchmark for measuring performance of qhmath_hvx_tanh_ahf function.

    Benchmark measures number of cycles needed for executing
    qhmath_hvx_tanh_ahf function certain number of times
...
BENCH_TFUN(qhmath_hvx_tanh_ahf, input_arr, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhmath_hvx_tanh_ahf, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
