/**=============================================================================
@file
   test_ah_convert_aqf16.c

@brief
    Accuracy test for qhmath_hvx_ah_convert_aqf16 function
...
int main() {
    ...
    qhmath_hvx_ah_convert_aqf16_ref (qf_ref, int_ref, SIZE);
    qhmath_hvx_ah_convert_aqf16 (qf_ref, int_test, SIZE);

    //compare bit accuracy  of qfloat conversion to int16

    if(qhmath_hvx_cmp_h(int_ref, int_test, SIZE, 1)) {
       printf("Conversion: qf16 -> int16 mismatches with reference implementation, FAIL!\n");
    } else {
       printf("Conversion: qf16 -> int16  matches with reference implementation, PASS! \n");
    }
/*======================================================================*/
    free(arg);
    free(int_test);
