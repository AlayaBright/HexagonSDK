...
@brief
    Benchmark for measuring performance of qhmath_hvx_modexp_ahf function.

    Benchmark measures number of cycles needed for executing
    qhmath_hvx_modexp_ahf function certain number of times
...
BENCH_TFUN_CLIPPING(qhmath_hvx_modexp_ahf, input_arr, output, k)
...
int main(void)
{
    ...
    BENCH_TCALL(qhmath_hvx_modexp_ahf, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
