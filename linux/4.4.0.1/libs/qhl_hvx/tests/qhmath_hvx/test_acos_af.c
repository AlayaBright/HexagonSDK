...
@brief
    Accuracy test for qhmath_hvx_acos_af function
...
inline static void Generate_input_float(float* input1, uint32_t length, range_float_t* range)
{
...
int main(void)
{
    ...
    printf("Test for qhmath_hvx_acos_af function:\n");
    ...
    for (uint32_t i = ARR_LEN; i <= ARR_LEN; ++i)
    {
        ...
        qhmath_hvx_acos_af(input, output, i);
