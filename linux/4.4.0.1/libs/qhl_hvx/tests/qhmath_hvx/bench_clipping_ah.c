...
@brief
    Benchmark for measuring performance of qhmath_hvx_clipping_ah function.

    Benchmark measures number of cycles needed for executing
    qhmath_hvx_clipping_ah function certain number of times
...
BENCH_TFUN_CLIPPING(qhmath_hvx_clipping_ah, input_arr, output, low_level, high_level)
...
int main(void)
{
    ...
    BENCH_TCALL(qhmath_hvx_clipping_ah, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
