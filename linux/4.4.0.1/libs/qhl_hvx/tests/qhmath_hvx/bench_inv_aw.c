...
@brief
    Benchmark for measuring performance of qhmath_hvx_inv_aw function.

    Benchmark measures number of cycles needed for executing
    qhmath_hvx_inv_aw function certain number of times
...
BENCH_TFUN(qhmath_hvx_inv_aw, input_arr1, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhmath_hvx_inv_aw, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
