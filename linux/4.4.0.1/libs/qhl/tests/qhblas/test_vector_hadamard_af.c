/**=============================================================================
@file
    test_vector_hadamard_af.c

@brief
    Accuracy test for qhblas_vector_hadamard_af function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A2(qhblas_vector_hadamard_af)

    TEST_INPUT_AF2(qhblas_vector_hadamard_af)
