/**=============================================================================
@file
    bench_matrix_inverse4x4_ah.c

@brief
    Benchmark for measuring performance of matrix_inverse4x4_ah function.

    Benchmark measures number of cycles needed for executing matrix_inverse4x4_ah function
...
BENCH_TFUN_AF2_MATRIX(__qhblas_matrix_inverse4x4_ah);

int main(int argc, char const *argv[])
{
    performance_high();

    printf("Benchmark for matrix inverse 4x4 16bit\n\n");
    BENCH_MATRIX_INPUT_INIT_H(VEC_LEN, MATRIX_N);
    // initialize test array
    BENCH_AH4_INPUT_INIT_MATRIX(RANGE_CNT0, RAND_MAX, lengths_of_arrays, VEC_LEN);

    BENCH_TCALL(__qhblas_matrix_inverse4x4_ah, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN);
