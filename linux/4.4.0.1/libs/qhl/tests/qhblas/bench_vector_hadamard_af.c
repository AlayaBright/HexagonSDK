/**=============================================================================
@file
    bench_vector_hadamard_af.c

@brief
    Benchmark for measuring performance of qhblas_vector_hadamard_af function.

    Benchmark measures number of cycles needed for executing qhblas_vector_hadamard_af function
...
BENCH_TFUN(qhblas_vector_hadamard_af, input_arr1, input_arr2, output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_vector_hadamard_af, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
