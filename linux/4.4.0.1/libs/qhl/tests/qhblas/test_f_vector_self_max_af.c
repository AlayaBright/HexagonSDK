/**=============================================================================
@file
    test_vector_max_af.c

@brief
    Accuracy test for qhblas_f_vector_self_max_af function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_f_vector_self_max_af)

    TEST_INPUT_SCALAR_FLOAT(qhblas_f_vector_self_max_af, ARR_LEN, output, input_arr)
