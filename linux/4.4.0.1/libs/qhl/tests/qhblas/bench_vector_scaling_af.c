/**=============================================================================
@file
    bench_vector_scaling_af.c

@brief
    Benchmark for measuring performance of qhblas_vector_scaling_af function.

    Benchmark measures number of cycles needed for executing qhblas_vector_scaling_af function
...
static float_a8_t input_arr[VEC_MAX_ARR_LEN];
static float scale_factor = 2.348f;
static float_a8_t output[VEC_MAX_ARR_LEN];
...
BENCH_TFUN(qhblas_vector_scaling_af, input_arr, scale_factor, output);
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_vector_scaling_af, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
