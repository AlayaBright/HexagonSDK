/**=============================================================================
@file
    test_vector_hadamard_acf.c

@brief
    Accuracy test for qhblas_vector_hadamard_acf function
...
static float complex spec_value[] = {
    {  0,         0        },
    { -0,        -0        },
    { -INFINITY, -INFINITY },
    {  INFINITY,  INFINITY },
...
static cfloat_a8_t output[ARR_LEN];
static cfloat_a8_t ref_output[ARR_LEN];
...
#define NUM_SPEC_VALUE (sizeof(spec_value)/sizeof(float complex))
...
int main(void)
{
    ...
    INIT_INPUT_CFLOAT_INDEX(input_arr1, ARR_LEN, ranges0, RANGE_CNT0, RAND_MAX, NUM_SPEC_VALUE)
    INIT_INPUT_CFLOAT_INDEX(input_arr2, ARR_LEN, ranges0, RANGE_CNT0, RAND_MAX, NUM_SPEC_VALUE)

    TEST_INVALID_INPUT_A2(qhblas_vector_hadamard_acf)

    TEST_INPUT_ACF2(qhblas_vector_hadamard_acf)
