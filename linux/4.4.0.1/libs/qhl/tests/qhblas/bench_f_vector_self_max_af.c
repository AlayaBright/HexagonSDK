...
@brief
    Benchmark for measuring performance of qhblas_f_vector_self_max_af function.

    Benchmark measures number of cycles needed for executing qhblas_f_vector_self_max_af function
...
BENCH_TFUN(qhblas_f_vector_self_max_af, input_arr, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_f_vector_self_max_af, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
