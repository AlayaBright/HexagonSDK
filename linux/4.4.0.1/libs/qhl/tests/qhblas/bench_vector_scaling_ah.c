/**=============================================================================
@file
    bench_vector_scaling_ah.c

@brief
    Benchmark for measuring performance of qhblas_vector_scaling_ah function.

    Benchmark measures number of cycles needed for executing qhblas_vector_scaling_ah function
...
static int16_a8_t input_arr[VEC_MAX_ARR_LEN];
static int16_t scale_factor = (int16_t)(0.3*32768);
static int16_a8_t output[VEC_MAX_ARR_LEN];
...
BENCH_TFUN(qhblas_vector_scaling_ah, input_arr, scale_factor, output);
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_vector_scaling_ah, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
