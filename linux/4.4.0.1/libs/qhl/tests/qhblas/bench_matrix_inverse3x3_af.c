/**=============================================================================
@file
    bench_matrix_inverse3x3_af.c

@brief
    Benchmark for measuring performance of matrix_inverse3x3_af function.

    Benchmark measures number of cycles needed for executing matrix_inverse3x3_af function
...
BENCH_TFUN_AF2_MATRIX(__qhblas_matrix_inverse3x3_af);

int main(int argc, char const *argv[])
{
    performance_high();

    printf("Benchmark for matrix inverse 3x3 float\n\n");
    BENCH_MATRIX_INPUT_INIT(VEC_LEN, MATRIX_N);
    // initialize test array
    BENCH_AF4_INPUT_INIT_MATRIX(RANGE_CNT0, RAND_MAX, lengths_of_arrays, VEC_LEN);

    BENCH_TCALL(__qhblas_matrix_inverse3x3_af, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN);
