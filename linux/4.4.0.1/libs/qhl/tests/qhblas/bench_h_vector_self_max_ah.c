...
@brief
    Benchmark for measuring performance of qhblas_h_vector_self_max_ah function.

    Benchmark measures number of cycles needed for executing qhblas_h_vector_self_max_ah function
...
BENCH_TFUN(qhblas_h_vector_self_max_ah, input_arr, &output)
...
int main(void)
{
    ...
    BENCH_TCALL(qhblas_h_vector_self_max_ah, NR_OF_ITERATIONS, lengths_of_arrays, VEC_LEN)
