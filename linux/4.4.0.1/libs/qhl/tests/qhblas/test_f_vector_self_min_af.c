...
@brief
    Accuracy test for qhblas_f_vector_self_min_af function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_f_vector_self_min_af)

    TEST_INPUT_SCALAR_FLOAT(qhblas_f_vector_self_min_af, ARR_LEN, output, input_arr)
