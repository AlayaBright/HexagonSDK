/**=============================================================================
@file
    test_vector_min_ah.c

@brief
    Accuracy test for qhblas_h_vector_self_min_ah function
...
int main(void)
{
    ...
    TEST_INVALID_INPUT_A1(qhblas_h_vector_self_min_ah)

    TEST_INPUT_SCALAR_INT16(qhblas_h_vector_self_min_ah, ARR_LEN, output, input_arr)
