...
REPORT_NAME=report-accuracy_tests-simulator.txt
REPORT=$REPORTS_DIR/$REPORT_NAME

# Start with the new report every time
rm -f $REPORT

echo "Running accuracy tests on simulator ..."

if [[ ${Q6VERSION} = "v68" ]];
then
    HEX_SIM_ARG="-m${Q6VERSION}n_1024 --quiet"
elif [[ ${Q6VERSION} = "v66" ]];
then
    HEX_SIM_ARG="-m${Q6VERSION}g_1024 --quiet"
else
    HEX_SIM_ARG="-m${Q6VERSION}a_1024 --quiet"
fi
