...
@brief   Benchmark for measuring performance of qhmath_cosh_f function.

        Benchmark measures number of cycles needed for executing qhmath_cosh_f function
...
range_float_t ranges[] = {
  {0.0f, 0.0002f},
  {0.0002f, 0.2f},
  {0.2f, 0.6900000000000001f},
  {0.6900000000000001f, 10.0f},
  {10.0f, 88.72f},
  {88.72f, 200.0f}
};
...
#ifdef BENCH_QHL
  BENCH_TFUN_F1(qhmath_cosh_f, ARR_LEN);
#elif BENCH_OPENLIBM || BENCH_MUSL || BENCH_GLIBC || BENCH_HSDK
  BENCH_TFUN_F1(coshf, ARR_LEN);
#endif
