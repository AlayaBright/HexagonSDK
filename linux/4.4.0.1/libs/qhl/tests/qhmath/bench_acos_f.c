...
@brief
    Benchmark for measuring performance of qhmath_acos_f function.

    Benchmark measures number of cycles needed for executing qhmath_acos_f function
...
#ifdef BENCH_QHL
  BENCH_TFUN_F1(qhmath_acos_f, ARR_LEN);
#elif BENCH_OPENLIBM || BENCH_MUSL || BENCH_GLIBC || BENCH_HSDK
  BENCH_TFUN_F1(acosf, ARR_LEN);
#endif
