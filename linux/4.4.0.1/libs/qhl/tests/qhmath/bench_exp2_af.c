...
@brief
    Benchmark for measuring performance of qhmath_exp2_af function.

    Benchmark measures number of cycles needed for executing qhmath_exp2_af function
...
BENCH_TFUN_AF3(qhmath_exp2_af, ARR_LEN);

int main(int argc, char const *argv[])
{
    performance_high();

    printf("Benchmark for qhmath_exp2_af\n\n");

    // initialize test array
    BENCH_AF3_INPUT_INIT(ARR_LEN, RANGE_CNT0, RAND_MAX);

    TCALL(qhmath_exp2_af);
