...
@brief
    Benchmark for measuring performance of qhmath_atan2_af function.

    Benchmark measures number of cycles needed for executing qhmath_atan2_af function
...
BENCH_TFUN_AF4(qhmath_atan2_af, ARR_LEN);

int main(int argc, char const *argv[])
{
    performance_high();

    printf("Benchmark for qhmath_atan2_af\n\n");

    // initialize test array
    BENCH_AF4_INPUT_INIT(ARR_LEN, RANGE_CNT0, RANGE_CNT1, RAND_MAX);

    TCALL(qhmath_atan2_af);
