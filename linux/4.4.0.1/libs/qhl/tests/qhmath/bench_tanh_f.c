...
@brief
    Benchmark for measuring performance of qhmath_tanh_f function.

    Benchmark measures number of cycles needed for executing qhmath_tanh_f function
...
#ifdef BENCH_QHL
  BENCH_TFUN_F1(qhmath_tanh_f, ARR_LEN);
#elif BENCH_OPENLIBM || BENCH_MUSL || BENCH_GLIBC || BENCH_HSDK
  BENCH_TFUN_F1(tanhf, ARR_LEN);
#endif
