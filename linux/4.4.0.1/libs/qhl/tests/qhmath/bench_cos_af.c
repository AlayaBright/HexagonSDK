...
@brief
    Benchmark for measuring performance of qhmath_cos_af function.

    Benchmark measures number of cycles needed for executing qhmath_cos_af function
...
BENCH_TFUN_AF3(qhmath_cos_af, ARR_LEN);

int main(int argc, char const *argv[])
{
    performance_high();

    printf("Benchmark for qhmath_cos_af\n\n");
