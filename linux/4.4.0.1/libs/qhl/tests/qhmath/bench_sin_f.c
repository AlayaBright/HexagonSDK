...
@brief
    Benchmark for measuring performance of qhmath_sin_f function.

    Benchmark measures number of cycles needed for executing qhmath_sin_f function
...
#ifdef BENCH_QHL
  BENCH_TFUN_F1(qhmath_sin_f, ARR_LEN);
#elif BENCH_OPENLIBM || BENCH_MUSL || BENCH_GLIBC || BENCH_HSDK
  BENCH_TFUN_F1(sinf, ARR_LEN);
#endif
