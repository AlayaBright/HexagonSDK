...
@brief
    Accuracy test for qhmath_atan2_af function
...
#define RANGE_CNT1         (sizeof(ranges0) / sizeof(range1))
...
int main(void)
{
    ...
    TEST_GEN_REF_AF4(qhmath_atan2_f)

    TEST_EXEC_PARAM_AF4(qhmath_atan2_af)

    TEST_EXEC_ACC_AF4(qhmath_atan2_af)
