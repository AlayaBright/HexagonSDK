...
@brief
    Benchmark for measuring performance of qhmath_exp_af function.

    Benchmark measures number of cycles needed for executing qhmath_exp_af function
...
BENCH_TFUN_AF3(qhmath_exp_af, ARR_LEN);

int main(int argc, char const *argv[])
{
    performance_high();

    printf("Benchmark for qhmath_exp_af\n\n");
