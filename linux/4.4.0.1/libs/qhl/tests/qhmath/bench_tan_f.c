...
@brief
    Benchmark for measuring performance of qhmath_tan_f function.

    Benchmark measures number of cycles needed for executing qhmath_tan_f function
...
#ifdef BENCH_QHL
  BENCH_TFUN_F1(qhmath_tan_f, ARR_LEN);
#elif BENCH_OPENLIBM || BENCH_MUSL || BENCH_GLIBC || BENCH_HSDK
  BENCH_TFUN_F1(tanf, ARR_LEN);
#endif
