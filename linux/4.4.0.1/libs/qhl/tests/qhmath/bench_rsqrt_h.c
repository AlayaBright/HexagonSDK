...
@brief
    Benchmark for measuring performance of qhmath_rsqrt_h function.

    Benchmark measures number of cycles needed for executing qhmath_rsqrt_h function
...
BENCH_TFUN_F1(qhmath_rsqrt_h, ARR_LEN);
