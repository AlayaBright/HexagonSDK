...
typedef float __attribute__ ((__aligned__(8))) float_a8_t;           /**< 8-byte aligned float */
typedef float complex __attribute__ ((__aligned__(8))) cfloat_a8_t;  /**< 8-byte aligned float complex */
typedef int16_t __attribute__ ((__aligned__(8))) int16_a8_t;         /**< 8-byte aligned int16_t */
 ...
 * @return      Function status: returns 0 on successful execution, otherwise -1.
 */
int32_t qhblas_h_vector_dot_ah(int16_a8_t *input_1, int16_a8_t *input_2, int64_t *output, uint32_t size);
 ...
 * @return      Function status: returns 0 on successful execution, otherwise -1.
 */
int32_t qhblas_h_vector_self_max_ah(int16_a8_t *input, int16_t *maximum, uint32_t size);
 ...
 * @return      Function status: returns 0 on successful execution, otherwise -1.
 */
int32_t qhblas_h_vector_self_min_ah(int16_a8_t *input, int16_t *minimum, uint32_t size);
 ...
 * @return      Function status: returns 0 on successful execution, otherwise -1.
 */
int32_t qhblas_h_vector_norm_ah(int16_a8_t *input, int32_t *output, uint32_t size);
 ...
 * @return      Function status: returns 0 on successful execution, otherwise -1.
 */
int32_t qhblas_f_vector_self_max_af(float_a8_t *input, float *maximum, uint32_t size);
 ...
 * @return      Function status: returns 0 on successful execution, otherwise -1.
 */
int32_t qhblas_f_vector_self_min_af(float_a8_t *input, float *minimum, uint32_t size);
 ...
 * @return      Function status: returns 0 on successful execution, otherwise -1.
 */
int32_t qhblas_f_vector_norm_af(float_a8_t *input, float *output, uint32_t size);
 ...
 * @return      Function status: returns 0 on successful execution, otherwise -1.
 */
int32_t qhblas_cf_vector_dot_acf(cfloat_a8_t *input_1, cfloat_a8_t *input_2, float complex *output, uint32_t size);
