...
typedef uint16_t __attribute__ ((__aligned__(8))) uint16_a8_t;  /**< 8-byte aligned uint16_t */
typedef int32_t __attribute__ ((__aligned__(8))) int32_a8_t;    /**< 8-byte aligned int32_t */
typedef uint32_t __attribute__ ((__aligned__(8))) uint32_a8_t;  /**< 8-byte aligned uint32_t */
